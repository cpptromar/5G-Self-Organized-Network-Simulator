...
enum class IRP_BSStatus { normal = 0, almostcongested, congestionDemand, congestionUsers, failure, excessiveUptilt, excessiveDowntilt, reductionInPower, coverageHole, tooLateHandover, intercellInterference};
